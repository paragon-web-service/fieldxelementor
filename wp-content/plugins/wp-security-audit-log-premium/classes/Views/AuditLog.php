...
class WSAL_Views_AuditLog extends WSAL_AbstractView {
	...
	public function ajax_switch_db() {
		...
		if ( isset( $post_array['selected_db'] ) ) {
			WpSecurityAuditLog::set_transient( 'wsal_wp_selected_db', $post_array['selected_db'], HOUR_IN_SECONDS );
			WpSecurityAuditLog::set_transient( 'wsal_wp_selected_db_user', get_current_user_id(), HOUR_IN_SECONDS );
		}
	}
	/* @premium:end */
