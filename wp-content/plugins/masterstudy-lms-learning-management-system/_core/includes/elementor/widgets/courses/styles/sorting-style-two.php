...
$this->add_group_control(
	...
	array(
		...
		'selector'       => '{{WRAPPER}} .ms_lms_courses_archive__sorting_select_label',
...
$this->add_group_control(
	...
	array(
		...
		'types'          => array( 'classic', 'gradient' ),
		'selector'       => '{{WRAPPER}} .ms_lms_courses_archive__sorting span.select2-selection--single',
		'fields_options' => array(
			'background' => array(
...
$this->add_group_control(
	...
	array(
		...
		'types'    => array( 'classic', 'gradient' ),
		'selector' => '{{WRAPPER}} .ms_lms_courses_archive__sorting span.select2-results ul.select2-results__options li.select2-results__option:not([aria-selected=true])',
	)
);
